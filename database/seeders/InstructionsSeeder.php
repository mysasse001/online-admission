...
class InstructionsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('instructions')->insert([
            'instruction'=>'
            [2022-01-19 08:15:26] local.INFO: <p class="MsoNormal" style="text-align:justify"><span class="infotext"><b style="mso-bidi-font-weight:normal"><span style="font-family:&quot;Arial&quot;,&quot;sans-serif&quot;">Registration</span></b></span>
                </p>
