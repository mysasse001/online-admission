...
<div class="">
    ...
    @endif
    <form id="msform" action="{{route('step6.store')}}" class="position-relative" enctype="multipart/form-data" method="POST" novalidate>
        @csrf
        <!-- progressbar -->
            ...
            <fieldset class="p-3  w-100 position-relative m-0">
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <select class="form-control @error('title_id') is-invalid @enderror" name="title_id" id="">
                            @if(auth()->user()->nextOfKin->title_id)
                            <option value="{{auth()->user()->nextOfKin->title_id}}">{{auth()->user()->nextOfKin->title->name}}</option>
                            @else
                            <option value="auth()->user()->nextOfKin->title_id">--select  Title--</option>
                            @endif
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input type="text"  name="name" value="{{auth()->user()->nextOfKin->name}}"id="" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                          <label for="">Relationship</label>
                          <select class="form-control" name="relationship_id" id="">
                            @if(auth()->user()->nextofKin->relationship_id)
                            <option value="{{auth()->user()->nextOfKin->relationship_id}}">{{auth()->user()->nextOfKin->relationship->name}}</option>
                            @else
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="APPAPPLICANTUSER_MOBILE_NO">Mobile No <span
                                    class="text-red">*</span></label><input value="{{auth()->user()->nextOfKin->telephone}}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="APPAPPLICANTUSER_EMAIL_ADDRESS">Email Address <span
                                    class="text-red">*</span></label><input value="{{auth()->user()->nextOfKin->email}}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="PostalAddress">Postal Address <span
                                    class="text-red">*</span></label><input value="{{auth()->user()->nextOfKin->postal_address}}"
                                class="form-control nopaste @error('postal_address') is-invalid @enderror" name="postal_address"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="postalCode">Postal Code <span
                                    class="text-red">*</span></label><input value="{{auth()->user()->nextOfKin->postal_code}}"
                                class="form-control nopaste @error('postal_code') is-invalid @enderror" name="postal_code"
                                type="text" maxlength="100" />
                            @error('code')
                            <span class="text-red">{{$message}}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="PostalAddress">Town <span
                                    class="text-red">*</span></label><input value="{{auth()->user()->nextOfKin->town}}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="PostalAddress">Nationality <span
                                    class="text-red">*</span></label><input value="{{auth()->user()->nextOfKin->nationality}}"
                                class="form-control nopaste @error('nationality') is-invalid @enderror" name="nationality"
                                type="text" maxlength="100" />
                            @error('nationality')
                            <span class="text-red">{{$message}}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="gender" id="">
                            @if(auth()->user()->nextOfKin->gender)
                            <option value="auth()->user()->nextOfKin->gender">{{auth()->user()->nextOfKin->gender}}</option>
                            @else
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="identification_document_id" id="">
                        @if(auth()->user()->nextOfKin->identification_document_id)
                        <option value="{{auth()->user()->nextOfKin->identification_document_id}}">{{auth()->user()->nextOfKin->identificationDocument->name}}</option>
                        @else
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="identification_document_no" value="{{auth()->user()->nextOfKin->identification_document_no}}" id="" class="form-control" placeholder="" aria-describedby="helpId">
                  </div>
                      </div>
                </div>
                <div class="float-right">
                    <button type="submit" class="btn btn-primary btn-sm">SAVE NEXT OF KIN CONTACTS</button>
                </div>
                <div class="d-flex align-items-center justify-content-between py-3 mt-5">
                    <a href="{{route('step5')}}" class="btn btn-secondary ">Previous</a>
                    <a href="{{route('step7')}}" class="btn btn-primary  ms-2">Next</a>
                </div>
            </fieldset>
        </div>
    </form>
