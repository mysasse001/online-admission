...
<div class="">
    ...
    @endif
    <form id="msform" class="position-relative" action="{{route('step5.store')}}" enctype="multipart/form-data" method="POST" novalidate>
        @csrf
        <!-- progressbar -->
        ...
        <div class="mt-3">
            <fieldset class="p-3  w-100 position-relative">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">Applicant Name</label>
                            <input type="text" disabled value="{{auth()->user()->surname}} {{auth()->user()->name}}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="APPAPPLICANTUSER_MOBILE_NO">Alternative Mobile No <span
                                    class="text-red">*</span></label><input
                                class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{auth()->user()->contactInformation->telephone}}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="APPAPPLICANTUSER_EMAIL_ADDRESS">Alternative Email Address <span
                                    class="text-red">*</span></label><input
                                class="form-control nopaste @error('email') is-invalid @enderror" name="email" value="{{auth()->user()->contactInformation->email}}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="PostalAddress">Postal Address <span class="text-red">*</span></label><input
                                class="form-control nopaste @error('postal_address') is-invalid @enderror" name="postal_address" value="{{auth()->user()->contactInformation->postal_address}}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="postalCode">Postal Code <span class="text-red">*</span></label><input
                                class="form-control nopaste @error('postal_code') is-invalid @enderror" name="postal_code" value="{{auth()->user()->contactInformation->postal_code}}"
                                type="text" maxlength="100" />
                            @error('postal_code')
                            <span class="text-red">{{$message}}</span>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="PostalAddress">Town <span class="text-red">*</span></label><input
                                class="form-control nopaste @error('town') is-invalid @enderror" name="town" value="{{auth()->user()->contactInformation->town}}"
                                type="text" maxlength="100" />
                            @error('town')
                            <span class="text-red">{{$message}}</span>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="PostalAddress">Nationality <span class="text-red">*</span></label><input
                                class="form-control nopaste @error('nationality') is-invalid @enderror" name="nationality" value="{{auth()->user()->contactInformation->nationality}}"
                                type="text" maxlength="100" />
                            @error('nationality')
                            <span class="text-red">{{$message}}</span>
                            @enderror
                ...
                <h4 class="font-weight-bold text-center">Kenya</h4>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            <label for="">County/City/Province</label>
                            <input type="text" name="province" id="" value="{{auth()->user()->contactInformation->province}}" class="form-control @error('province') is-invalid @enderror" placeholder=""
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="">Sub-county/District</label>
                            <input type="text" name="district" id="" value="{{auth()->user()->contactInformation->district}}" class="form-control @error('district') is-invalid @enderror" placeholder=""
                                aria-describedby="helpId">
                             @error('district')
                             <span style="color:red">{{$message}}</span>
                             @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="constituency" id="" value="{{auth()->user()->contactInformation->constituency}}" class="form-control @error('constituency') is-invaid @enderror" placeholder=""
                                aria-describedby="helpId">
                                @error('constituency')
                                <span style="color:red">{{$message}}</span>
                                @enderror
                ...
                <div class="float-right">
                 <button class="btn btn-primary btn-sm" type="submit">SAVE YOUR CONTACT INFORMATION</button>
                </div>
                    <div class="d-flex align-items-center justify-content-between py-3 mt-5">
                        <a href="{{route('step4')}}" class="btn btn-secondary">Previous</a>
                            <a href="{{route('step6')}}" class="btn btn-primary ms-2">Next</a>
                    </div>
