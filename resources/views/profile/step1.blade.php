...
<div class="">
    ...
    @endif
    <form id="msform" class="position-relative" action="{{route('step1.store')}}" enctype="multipart/form-data" method="POST" novalidate>
        @csrf
        <!-- progressbar -->
            ...
            <fieldset class="p-3  w-100 position-relative m-0">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <select class="form-control @error('title_id') is-invalid @enderror" name="title_id" id="">
                            @if(auth()->user()->title_id)
                            <option value="{{auth()->user()->title_id}}">{{auth()->user()->title->name}}</option>
                            @else
                    ...
                    <div class="form-group col-md-5">
                        <label for="APPAPPLICANTUSER_SURNAME">Surname <span class="text-red">*</span></label><input
                            class="form-control @error('surname') is-invalid @enderror" value="{{auth()->user()->surname}}" name="surname" type="text"
                            maxlength="100" />
                        @error('surname')
                    ...
                    <div class="form-group col-md-5">
                        <label for="APPAPPLICANTUSER_OTHER_NAME">Firstname | Middlename
                            ...
                            class="form-control @error('name') is-invalid @enderror" value="{{auth()->user()->name}}" name="name" type="text"
                            maxlength="100" />
                        @error('name')
                        <span class="text-red">{{$message}}</span>
                        @enderror
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="APPAPPLICANTUSER_MOBILE_NO">Mobile No <span
                                ...
                                class="form-control @error('telephone') is-invalid @enderror" value="{{auth()->user()->telephone}}" name="telephone"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="APPAPPLICANTUSER_EMAIL_ADDRESS">Email Address <span
                                    class="text-red">*</span></label><input
                                class="form-control nopaste @error('email') is-invalid @enderror" value="{{auth()->user()->email}}" name="email"
             ...
             <div class="float-right">
                ...
                <div class="d-inline-flex">
                    ...
                    <span id="ms-2">Save Primary Information</span>
                </div>
             </div>
        <div class="py-3 d-flex justify-content-end mt-5">
            <a href="{{route('step2')}}" class="btn btn-primary">Next</a>
        </div>
