    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          ...
          <a href="{{ route('admin.message.index') }}" class="btn btn-primary btn-block mb-3">Inbox</a>
                ...
                <table class="table table-hover table-striped">
                  <tbody>
                     ...
                     <tr>
                         ...
                         <td class="mailbox-subject"><b>{{ $message->subject }}</b> - {{ Str::limit($message->message,50) }}
                         </td>
